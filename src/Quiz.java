...
public class Quiz {
        ...
        public static void main(String[] args) throws Exception {
                ...
                gameIntro();
                Question[] qList = { q1, q2, q3, q4, q5, q6, q7, q8, q9 };// make it so q9 is only asked if there is a
                                                                          // tie
                ...
                int index = getMostPopularCatIndex(cList); // CREATE IF STATEMENT HERE TO CHECK IF TIE, IF THERE IS A
                                                           // TIE, RUN A FUNCTION, IF NOT, CONTINUE
